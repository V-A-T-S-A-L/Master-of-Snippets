			...
			<div className="container mx-auto flex justify-between items-center">
				...
				<div className='flex'>
					...
					<a
						...
						className="text-sm font-medium text-center text-gray-800 rounded-lg border-2 border-gray-400 dark:border-gray-400 dark:text-white bg-white dark:bg-gray-800 hover:bg-blue-600 rounded-lg px-4 py-2 ml-4 transition-all duration-300"
					>
						Contribute
					</a>
				</div>
